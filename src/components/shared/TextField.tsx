...
import { TextField as MuiTextField, TextFieldProps as MuiTextFieldProps, InputBaseProps, styled } from '@mui/material';
...
const TextField = (props: TextFieldProps) => {
    const {
        placeholder = props?.multiline ? 'Jot something down...' : 'Enter here...',
        defaultValue,
        InputProps,
        clearForm,
        onChangeText,
